...
- **Available Methods:**
  ...
  * `add_item` (constant: `ADD_ITEM`)
  * `buy_item` (constant: `BUY_ITEM`)
  * `get_available_items` (constant: `GET_AVAILABLE_ITEMS`)
  * `get_transaction_history` (constant: `GET_TRANSACTION_HISTORY`)
  * `get_item_name` (constant: `GET_ITEM_NAME`)
  * `get_item_price` (constant: `GET_ITEM_PRICE`)
  * `get_item_seller` (constant: `GET_ITEM_SELLER`)
  * `is_item_sold` (constant: `IS_ITEM_SOLD`)

---

# **Move Contract: `contract/marketplace/sources/marketplace.move`**
...
- Use Package ID: `0xc3694638e3c0bb2ae0660de6aa10b2e1cd17f1fb089119820ef1254051dd7525` and Module: `contract`
